...
const SingleProductPage = () => {
  ...
  useEffect(
    () => getSingleProductHandler(productId, setProduct, setLoader),
    []
  );
              ...
              <div className="product-details">
                ...
                <div className="action-btns">
                  <button
                    ...
                    disabled={
                      product.badge === "Out of Stock" ? true : cartButtonLoader
                    }
                    onClick={() => checkCartRouteHandler(product._id)}
                  >
                    {product.badge === "Out of Stock"
                      ? "Out of Stock"
                      : checkCartAction(product._id)}
                  </button>
                  <button
                  ...
                  >
                    {checkWishlistAction(product._id)
                      ? "Added to Wishlist"
                      : "Add to Wishlist"}
                  </button>
                </div>
